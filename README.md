...
Um sistema de matching entre usuários e hotéis/pousadas, similar ao Tinder mas para hospedagem.
...
O design usa Tailwind CSS e pode ser facilmente personalizado editando as classes nos componentes em `src/components/`.

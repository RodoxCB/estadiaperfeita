...
export default function SearchPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-neo-bg to-neo-surface">
        <div className="glass rounded-2xl p-8 shadow-neo text-center">
          <div className="animate-spin rounded-full h-32 w-32 border-b-2 border-neo-primary mx-auto"></div>
          <p className="mt-4 text-neo-secondary">Buscando seus matches perfeitos...</p>
        </div>
      </div>
    )
  }
  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-neo-bg to-neo-surface">
        <div className="glass rounded-2xl p-8 shadow-neo text-center max-w-md mx-auto">
    ...
    <div className="min-h-screen bg-gradient-to-br from-neo-bg to-neo-surface">
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          <div className="glass rounded-2xl p-8 max-w-2xl mx-auto shadow-neo">
            ...
            <p className="text-neo-secondary/80">
        ...
        {hotels.length === 0 ? (
          <div className="glass rounded-2xl p-8 max-w-md mx-auto shadow-neo text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {hotels.map((hotel) => (
              <div key={hotel.id} className="glass rounded-2xl overflow-hidden shadow-neo hover:shadow-neo-lg transition-neo hover:scale-[1.02]">
                ...
                <div className="p-6">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <span className="glass px-3 py-1 rounded-full text-xs font-medium text-green-600">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {hotel.amenities.slice(0, 3).map((amenity, index) => (
                      <span key={index} className="glass px-3 py-1 rounded-full text-xs text-neo-primary">
                        {amenity}
                      </span>
                    ))}
                  </div>

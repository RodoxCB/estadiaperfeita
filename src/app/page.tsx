...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-neo-bg via-neo-surface to-white relative overflow-hidden">
      {/* Elementos decorativos de fundo */}
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-20 left-10 w-32 h-32 bg-neo-primary/20 rounded-full blur-xl"></div>
        <div className="absolute bottom-20 right-10 w-48 h-48 bg-neo-secondary/15 rounded-full blur-2xl"></div>
      </div>

      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="text-center">
          <div className="glass-strong rounded-3xl p-8 mb-8 max-w-4xl mx-auto">
            <h1 className="text-6xl font-bold bg-gradient-to-r from-neo-primary to-neo-secondary bg-clip-text text-transparent mb-6">
              Estadia Perfeita
            </h1>
            <p className="text-xl text-neo-secondary/80 mb-8 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="mt-20 grid md:grid-cols-3 gap-8">
          <div className="glass rounded-2xl p-8 shadow-neo hover:shadow-neo-lg transition-neo">
            <div className="text-4xl mb-6">🏖️</div>
            <h3 className="text-xl font-semibold mb-4 text-neo-primary">Preferências Personalizadas</h3>
            <p className="text-neo-secondary/80 leading-relaxed">
